...
(function (sunnet) {
    ...
    var NetConnectionNotifier = /** @class */ (function () {
         ...
         * 通知网络消息
         */
        NetConnectionNotifier.prototype.notify = function (cmd, data) {
         ...
         * 注册网络消息监听
         */
        NetConnectionNotifier.prototype.register = function (cmd, method, caller) {
            if ((suncom.Global.debugMode & suncom.DebugMode.NETWORK) === suncom.DebugMode.NETWORK) {
         ...
         * 移除网络消息监听
         */
        NetConnectionNotifier.prototype.unregister = function (cmd, method, caller) {
            if ((suncom.Global.debugMode & suncom.DebugMode.NETWORK) === suncom.DebugMode.NETWORK) {
